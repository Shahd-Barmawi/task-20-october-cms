...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="<?= Backend::url('training/services/blogcategories') ?>">
            Blog Categories
        </a>
    </li>
    ...
    <div class="form-buttons">
        <div data-control="loader-container">
            ...
            <button
                ...
                data-request-message="Saving Blog Category..."
            ...
            <button
                ...
                data-request-message="Deleting Blog Category..."
            ...
            <span class="btn-text">
                ...
                <a
                    href="<?= Backend::url('training/services/blogcategories') ?>"
