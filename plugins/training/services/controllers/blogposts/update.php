...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="<?= Backend::url('training/services/blogposts') ?>">
            Blog Posts
        </a>
    </li>
    ...
    <div class="form-buttons">
        <div data-control="loader-container">
            ...
            <button
                ...
                data-request-message="Saving Blog Post..."
            ...
            <button
                ...
                data-request-message="Deleting Blog Post..."
            ...
            <span class="btn-text">
                ...
                <a
                    href="<?= Backend::url('training/services/blogposts') ?>"
