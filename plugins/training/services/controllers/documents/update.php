...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="<?= Backend::url('training/services/documents') ?>">
            Documents
        </a>
    </li>
    ...
    <div class="form-buttons">
        <div data-control="loader-container">
            ...
            <button
                ...
                data-request-message="Saving Document..."
            ...
            <button
                ...
                data-request-message="Deleting Document..."
            ...
            <span class="btn-text">
                ...
                <a
                    href="<?= Backend::url('training/services/documents') ?>"
