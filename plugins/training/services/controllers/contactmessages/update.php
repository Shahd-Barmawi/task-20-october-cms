...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="<?= Backend::url('training/services/contactmessages') ?>">
            Contact Messages
        </a>
    </li>
    ...
    <div class="form-buttons">
        <div data-control="loader-container">
            ...
            <button
                ...
                data-request-message="Saving Contact Message..."
            ...
            <button
                ...
                data-request-message="Deleting Contact Message..."
            ...
            <span class="btn-text">
                ...
                <a
                    href="<?= Backend::url('training/services/contactmessages') ?>"
