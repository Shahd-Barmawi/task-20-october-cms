...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="<?= Backend::url('training/services/documentcategories') ?>">
            Document Categories
        </a>
    </li>
    ...
    <div class="form-buttons">
        <div data-control="loader-container">
            ...
            <button
                ...
                data-request-message="Saving Document Category..."
            ...
            <button
                ...
                data-request-message="Deleting Document Category..."
            ...
            <span class="btn-text">
                ...
                <a
                    href="<?= Backend::url('training/services/documentcategories') ?>"
