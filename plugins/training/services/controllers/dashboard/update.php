...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="<?= Backend::url('training/services/dashboard') ?>">
            Dashboard
        </a>
    </li>
    ...
    <div class="form-buttons">
        <div data-control="loader-container">
            ...
            <button
                ...
                data-request-message="Saving Dashboard..."
            ...
            <button
                ...
                data-request-message="Deleting Dashboard..."
            ...
            <span class="btn-text">
                ...
                <a
                    href="<?= Backend::url('training/services/dashboard') ?>"
